...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'lgrencoder' => 'getLgrencoderService',
            ...
            'security_userprovider' => 'getSecurityUserproviderService',
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8c3f1133312f517435cd827ed0ca7270872b1a8748548aebe7225a7df1a885d1');
    ...
    /**
     * Gets the 'lgrencoder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\Encoder\LgrEncoder A AppBundle\Security\Encoder\LgrEncoder instance.
     */
    protected function getLgrencoderService()
    {
        return $this->services['lgrencoder'] = new \AppBundle\Security\Encoder\LgrEncoder();
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('AppBundle\\Security\\WebserviceUser' => $this->get('lgrencoder')));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js|img|adminLTE)/'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), 'security.firewall.map.context.default' => NULL)), $this->get('debug.event_dispatcher'));
    }
    ...
    {
        $a = $this->get('security.token_storage');
        $b = $this->get('security_userprovider');
        ...
        $h = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), '783c469dfcfada00350a9fe25bb6c3a4b181b8fb', 'main', array('lifetime' => 2232000, 'name' => 'REMEMBERME', 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $c);
        ...
        $m = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, $j, $e, 'main', $k, $l, array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $c, $d, NULL);
        $m->setRememberMeServices($h);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b, 1 => $this->get('security.user.provider.concrete.in_memory')), 'main', $c, $d), 2 => $i, 3 => $m, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $h, $g, $c, $d, true, $j), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '56dfe3d79feeb3.22414632', $c, $g), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'login', false), NULL, NULL, $c, false));
    }
    ...
    /**
     * Gets the 'security_userprovider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurityUserproviderService()
    {
        return $this->services['security_userprovider'] = new \AppBundle\Security\UserProvider('http://devapi.gwi-hosting.fr/app_dev.php/api/soap/gwiHostingSecurity?wsdl');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('783c469dfcfada00350a9fe25bb6c3a4b181b8fb');
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/private/password-forgotten$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/private/register$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/private/login$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/private'), array(0 => 'ROLE_UTILISATEUR_AGENCE', 1 => 'ROLE_COMPTE_EMAIL'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security_userprovider'), $a, 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, '783c469dfcfada00350a9fe25bb6c3a4b181b8fb', 'main'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56dfe3d79feeb3.22414632'), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56dfe3d79feeb3.22414632')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_AGENCE' => array(0 => 'ROLE_UTILISATEUR_AGENCE'), 'ROLE_LEGRAIN' => array(0 => 'ROLE_AGENCE')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '783c469dfcfada00350a9fe25bb6c3a4b181b8fb',
            'wsdl_gwi_hosting_security' => 'http://devapi.gwi-hosting.fr/app_dev.php/api/soap/gwiHostingSecurity?wsdl',
            'wsdl_gwi_hosting' => 'http://devapi.gwi-hosting.fr/app_dev.php/api/soap/gwiHosting?wsdl',
            'twitter_oauth_access_token' => '4507102241-bntFZEaVsPpJpJArYUu2vUjJe9Cx1Bkv2UN5Xwl',
            'twitter_oauth_access_token_secret' => 'hcH76hhfVzTxyQrrfiKJdzwUhcnSt37JEzStr56TwO6U8',
            'twitter_consumer_key' => '3pjEkRDmLXHU3Dq3OR4KhAoNC',
            'twitter_consumer_secret' => 'vAUCYVC68GKpHI7BADInGTMQbDDoCyOEHGg1vY5CF3S7jdx2iL',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '783c469dfcfada00350a9fe25bb6c3a4b181b8fb',
