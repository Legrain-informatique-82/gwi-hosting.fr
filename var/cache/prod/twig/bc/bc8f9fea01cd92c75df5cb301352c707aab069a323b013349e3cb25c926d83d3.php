...
/* ::sidebar.html.twig */
class __TwigTemplate_d40e0d1a7df925e006f32bdc59f7968f4d5295db3249f0e0596d93db871a9562 extends Twig_Template
{
    ...
    <section class=\"sidebar\">
        <ul class=\"sidebar-menu\">
            ...
            if ($this->env->getExtension('security')->isGranted("ROLE_COMPTE_EMAIL")) {
                ...
                <li ";
                // line 10
                if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "my_email_account")) {
                    echo "class=\"active\"";
                }
                echo ">
                    <a href=\"";
            ...
            if ($this->env->getExtension('security')->isGranted("ROLE_LEGRAIN")) {
                ...
                <li class=\"treeview  ";
                // line 22
                if ((((($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "list-agency") || ($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "create-agency")) || ($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "list-users-agency")) || ($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "create-users-agency"))) {
                    echo " active ";
                }
                echo "\">
                    <a href=\"#\">
                    ...
                    <ul class=\"treeview-menu\">
                        <li ";
                // line 27
                if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "list-agency")) {
                    echo " class=\"active\" ";
                }
                echo "><a href=\"";
                ...
                echo "\"><i class=\"fa fa-circle-o\"></i> Agences </a></li>
                        <li ";
                // line 28
                if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "create-agency")) {
                    echo " class=\"active\" ";
                }
                echo "><a href=\"";
                ...
                echo "\"><i class=\"fa fa-circle-o\"></i> Ajouter une agence </a></li>
                        <li ";
                // line 29
                if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "list-users-agency")) {
                    echo " class=\"active\" ";
                }
                echo "><a href=\"";
                ...
                echo "\"><i class=\"fa fa-circle-o\"></i> Gestionnaires</a></li>
                        <li ";
                // line 30
                if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "create-users-agency")) {
                    echo " class=\"active\" ";
                }
                echo "><a href=\"";
                ...
                <li class=\"treeview  ";
                // line 37
                if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "list-products")) {
                    echo " active ";
                }
                echo "\">
                    <a href=\"#\">
                ...
                <li class=\"treeview  ";
                // line 48
                if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "adm_gest_ndd")) {
                    echo " active ";
                }
                echo "\">
                    <a href=\"#\">
                ...
                <li class=\"treeview  ";
                // line 58
                if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "liaison_instance_gandi")) {
                    echo " active ";
                }
                echo "\">
                    <a href=\"#\">
                ...
                <li class=\"treeview  ";
                // line 68
                if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "gestion-cgv")) {
                    echo " active ";
                }
                echo "\">
                    <a href=\"#\">
                ...
                <li class=\"treeview  ";
                // line 78
                if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "list-contacts")) {
                    echo " active ";
                }
                echo "\">
                    <a href=\"#\">
            ...
            if ($this->env->getExtension('security')->isGranted("ROLE_UTILISATEUR_AGENCE")) {
                ...
                if ($this->env->getExtension('security')->isGranted("ROLE_AGENCE")) {
                    ...
                    if ((($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "list_customer_admin") || ($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "add_customer_admin"))) {
                        echo " active ";
                    }
                    echo "\">
                        <a href=\"#\">
                        ...
                        <ul class=\"treeview-menu\">
                            <li ";
                    // line 100
                    if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "list_customer_admin")) {
                        echo " class=\"active\" ";
                    }
                    echo "><a href=\"";
                    ...
                    echo "\"><i class=\"fa fa-circle-o\"></i> Mes clients </a></li>
                            <li ";
                    // line 101
                    if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "add_customer_admin")) {
                        echo " class=\"active\" ";
                    }
                    echo "><a href=\"";
                    ...
                    echo "\"><i class=\"fa fa-circle-o\"></i> Ajouter un client </a></li>
                            <li ";
                    // line 102
                    if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "list_product_next_payement")) {
                        echo " class=\"active\" ";
                    }
                    echo "><a href=\"";
                    ...
                    // line 107
                    echo "                    ";
                    if ((($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array()), "user", array()), "agency", array()), "facturationBylegrain", array()) == false) || $this->env->getExtension('security')->isGranted("ROLE_LEGRAIN"))) {
                        // line 108
                        echo "                        <li class=\"treeview  ";
                        if ((($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "list-pricelists") || ($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "list-pricelists"))) {
                            echo " active ";
                        }
                        echo "\">
                            <a href=\"#\">
                            ...
                            <ul class=\"treeview-menu\">
                                <li ";
                        // line 113
                        if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "list-pricelists")) {
                            echo " class=\"active\" ";
                        }
                        echo "><a href=\"";
                        ...
                        echo "\"><i class=\"fa fa-circle-o\"></i> Mes grilles de tarifs</a></li>
                                <li ";
                        // line 114
                        if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "param-infos-paiements")) {
                            echo " class=\"active\" ";
                        }
                        echo "><a href=\"";
                ...
                echo "                <li class=\"treeview\">
                    ...
                    <ul class=\"treeview-menu\">
                        <li><a  ";
                // line 125
                if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "ndds_user")) {
                    echo " class=\"active\" ";
                }
                echo " href=\"";
                ...
                <li class=\"treeview\">
                    ...
                    <ul class=\"treeview-menu\">
                        <li><a  ";
                // line 134
                if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "instances_user")) {
                    echo " class=\"active\" ";
                }
                echo " href=\"";
...
";
    ...
    {
        return array (  353 => 289,  347 => 146,  328 => 134,  312 => 125,  305 => 120,  301 => 118,  290 => 114,  282 => 113,  271 => 108,  268 => 107,  257 => 102,  249 => 101,  241 => 100,  230 => 95,  228 => 94,  224 => 92,  221 => 91,  206 => 83,  196 => 78,  184 => 73,  174 => 68,  162 => 63,  152 => 58,  140 => 53,  130 => 48,  117 => 42,  107 => 37,  93 => 30,  85 => 29,  77 => 28,  69 => 27,  59 => 22,  55 => 20,  53 => 19,  50 => 18,  40 => 11,  34 => 10,  30 => 8,  28 => 7,  21 => 2,  19 => 1,);
    }
}
