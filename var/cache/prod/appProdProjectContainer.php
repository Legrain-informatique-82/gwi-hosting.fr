...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4e0dd24c08053d249770a822eb2c2839a8e43508f6aa6c1c3a21a8538da3c2f5');
        return $instance;
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b, 1 => $this->get('security.user.provider.concrete.in_memory')), 'main', $c, $d), 2 => $i, 3 => $m, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $h, $g, $c, $d, true, $j), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '56de9e2b129631.02153700', $c, $g), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'login', false), NULL, NULL, $c, false));
    }
    ...
    {
        return $this->services['security_userprovider'] = new \AppBundle\Security\UserProvider('http://api.gwi-hosting.fr/api/soap/gwiHostingSecurity?wsdl');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'wsdl_gwi_hosting_security' => 'http://api.gwi-hosting.fr/api/soap/gwiHostingSecurity?wsdl',
            'wsdl_gwi_hosting' => 'http://api.gwi-hosting.fr/api/soap/gwiHosting?wsdl',
            'locale' => 'en',
